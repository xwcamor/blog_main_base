...
class GenerateCompaniesWordJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        try {
            ...
            $wordExport = new CompaniesWord();
            $wordExport->generate($companies, $tempFile);
            ...
            \Log::error('GenerateCompaniesWordJob failed', [
                'error' => $e->getMessage(),
    ...
    {
        return __('companies.export_filename') . '_' . now()->format('Y-m-d_H-i-s') . '.docx';
    }
}
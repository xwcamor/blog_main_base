...
class GenerateTenantsWordJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        try {
            ...
            $wordExport = new TenantsWord();
            $wordExport->generate($tenants, $tempFile);
            ...
            \Log::error('GenerateTenantsWordJob failed', [
                'error' => $e->getMessage(),
    ...
    {
        return __('tenants.export_filename') . '_' . now()->format('Y-m-d_H-i-s') . '.docx';
    }
}

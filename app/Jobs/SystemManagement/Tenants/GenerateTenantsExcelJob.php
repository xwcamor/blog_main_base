...
class GenerateTenantsExcelJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        try {
            ...
            $content = Excel::raw(new TenantsExport($tenants), ExcelFormat::XLSX);
            ...
            \Log::error('GenerateTenantsExcelJob failed', [
                'error' => $e->getMessage(),
    ...
    {
        return __('tenants.export_filename') . '_' . now()->format('Y-m-d_H-i-s') . '.xlsx';
    }
}

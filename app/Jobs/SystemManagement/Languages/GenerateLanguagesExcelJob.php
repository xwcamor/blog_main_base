...
class GenerateLanguagesExcelJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        try {
            ...
            $content = Excel::raw(new LanguagesExport($languages), ExcelFormat::XLSX);
            ...
            \Log::error('GenerateLanguagesExcelJob failed', [
                'error' => $e->getMessage(),
    ...
    {
        return __('languages.export_filename') . '_' . now()->format('Y-m-d_H-i-s') . '.xlsx';
    }
}
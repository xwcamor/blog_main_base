...
class GenerateRegionsExcelJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        try {
            ...
            $content = Excel::raw(new RegionsExport($regions), ExcelFormat::XLSX);
            ...
            \Log::error('GenerateRegionsExcelJob failed', [
                'error' => $e->getMessage(),
    ...
    {
        return __('regions.export_filename') . '_' . now()->format('Y-m-d_H-i-s') . '.xlsx';
    }
}

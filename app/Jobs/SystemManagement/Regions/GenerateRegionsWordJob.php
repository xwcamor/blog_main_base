...
class GenerateRegionsWordJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        try {
            ...
            $wordExport = new RegionsWord();
            $wordExport->generate($regions, $tempFile);
            ...
            \Log::error('GenerateRegionsWordJob failed', [
                'error' => $e->getMessage(),
    ...
    {
        return __('regions.export_filename') . '_' . now()->format('Y-m-d_H-i-s') . '.docx';
    }
}

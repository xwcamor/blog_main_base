...
<div class="row">
  <div class="col-lg-12">
    <div class="card">
      ...
      <form id="form-save" action="{{ route('company_management.companies.store') }}" method="POST" enctype="multipart/form-data" data-parsley-validate>
        @csrf
        <div class="card-body">
          ...
          {{-- Número de Documento (se llenará con el DNI si es persona natural) --}}
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input type="text" name="num_doc" id="num_doc" class="form-control @error('num_doc') is-invalid @enderror"
                       value="{{ old('num_doc') }}" placeholder="{{ __('companies.num_doc') }}">
                @error('num_doc')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>

@extends('layouts.app')
@section('title', __('companies.edit_all_title'))
    ...
    <div class="col-lg-12">
        <div class="card card-info rounded">
            ...
            <div class="card-footer text-center">
                ...
                <a href="{{ route('company_management.companies.edit_all') }}" class="btn btn-default">
        ...
        <div class="card card-info rounded">
            <div class="card-header">
                ...
                <div class="card-tools">
                    ...
                    <a class="btn btn-sm bg-olive mr-2" href="{{ route('company_management.companies.index') }}">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    @include('company_management.companies.partials.edit_all_results')
                </div>
            </div>
        </div>
    </div>
...
@push('scripts')
    ...
    @include('company_management.companies.partials.edit_all_scripts')
@endpush

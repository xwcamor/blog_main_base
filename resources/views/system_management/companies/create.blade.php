  ...
  <div class="col-lg-12">
    <div class="card">
      <div class="card-header bg-light border-bottom font-weight-bold">
        <i class="fas fa-plus"></i> {{ __('companies.create_title') }}
      ...
      <div class="card-body">
        <form id="form-save" action="{{ route('system_management.companies.store') }}" method="POST" enctype="multipart/form-data" data-parsley-validate>
          @csrf
            ...
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input type="text" name="ruc" id="ruc" class="form-control @error('ruc') is-invalid @enderror"
                       value="{{ old('ruc') }}" placeholder="{{ __('companies.ruc') }}" maxlength="11" required>
                @error('ruc')
            ...
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input type="text" name="razon_social" id="razon_social" class="form-control @error('razon_social') is-invalid @enderror"
                       value="{{ old('razon_social') }}" placeholder="{{ __('companies.razon_social') }}" required>
                @error('razon_social')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
            ...
            <div class="col-md-12">
              <div class="form-group">
                ...
                <textarea name="direccion" id="direccion" class="form-control @error('direccion') is-invalid @enderror"
                          rows="3" placeholder="{{ __('companies.direccion') }}" required>{{ old('direccion') }}</textarea>
                @error('direccion')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
      ...
      <div class="card-footer text-center">
        <a href="{{ route('system_management.companies.index') }}" class="btn btn-secondary mr-2">
...
@section('scripts')
  @include('system_management.companies.partials.scripts')
@endsection

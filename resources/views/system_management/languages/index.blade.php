  ...
  <div class="col-lg-12">
    <div class="card card-info rounded">
      ...
      <div class="card-footer text-center">
        ...
        <a href="{{ route('system_management.languages.index') }}" class="btn btn-default">
    ...
    <div class="card card-info rounded">
        ...
        <div class="card-tools">
          ...
          <div class="btn-group">
            ...
            <div class="dropdown-menu dropdown-menu-right">
              ...
              <a class="dropdown-item text-dark" href="{{ route('system_management.languages.export_word', request()->query()) }}">
      ...
      <div class="card-body">
        <div class="table-responsive">
          @include('system_management.languages.partials.index_results')
        </div>
      </div>
    </div>
  </div>

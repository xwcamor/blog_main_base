...
@section('title', __('regions.edit_all_title'))
  ...
  <div class="col-lg-12">
    <div class="card card-info rounded">
      ...
      <div class="card-footer text-center">
        ...
        <a href="{{ route('system_management.regions.edit_all') }}" class="btn btn-default">
    ...
    <div class="card card-info rounded">
      <div class="card-header">
        ...
        <div class="card-tools">
          ...
          <a class="btn btn-sm bg-olive mr-2" href="{{ route('system_management.regions.index') }}">
      ...
      <div class="card-body">
        <div class="table-responsive">
          @include('system_management.regions.partials.edit_all_results')
        </div>
      </div>
    </div>
  </div>
...
@include('system_management.regions.partials.edit_all_scripts')
@endsection

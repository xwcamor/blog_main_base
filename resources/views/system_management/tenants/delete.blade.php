...
@section('title', __('tenants.delete_title'))
...
<div class="row">
  <div class="col-lg-12">
    <div class="card card-danger rounded">
      ...
      <div class="card-body">
        @include('system_management.tenants.partials.form_delete')
      </div>
      <div class="card-footer text-center">
        <button type="submit" onclick="confirmDelete()" class="btn btn-danger mr-4">
          <i class="fas fa-trash"></i> {{ __('global.destroy') }}
        </button>
        <a href="{{ route('system_management.tenants.index') }}" class="btn btn-default" title="{{ __('global.back') }}">

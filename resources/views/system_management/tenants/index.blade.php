...
@section('title', __('tenants.index_title'))
    ...
    <div class="card card-info rounded">
      <div class="card-header">
        ...
        <div class="card-tools">
          ...
          <a class="btn btn-sm bg-olive mr-2" href="{{ route('system_management.tenants.edit_all') }}">
          ...
          <div class="btn-group">
            ...
            <div class="dropdown-menu dropdown-menu-right">
              <a class="dropdown-item text-dark" href="{{ route('system_management.tenants.export_excel', request()->query()) }}">
                <i class="fas fa-file-excel text-success"></i> {{ __('global.excel') }}
              </a>
              <a class="dropdown-item text-dark" href="{{ route('system_management.tenants.export_pdf', request()->query()) }}">
                <i class="fas fa-file-pdf text-danger"></i> {{ __('global.pdf') }}
              </a>
              <a class="dropdown-item text-dark" href="{{ route('system_management.tenants.export_word', request()->query()) }}">
      ...
      <div class="card-body">
        <div class="table-responsive">
          @include('system_management.tenants.partials.index_results')
        </div>
      </div>
    </div>
  </div>

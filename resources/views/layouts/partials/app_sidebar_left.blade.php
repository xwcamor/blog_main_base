...
<li class="nav-item {{ menuOpenClass(['system_management/languages*','system_management/system_modules*','system_management/locales*']) }}">
    <a href="#" class="nav-link {{ activeClass(['system_management/languages*','system_management/system_modules*','system_management/locales*']) }}">
    ...
    <ul class="nav nav-treeview">
        ...
        <li class="nav-item">
            <a href="{{ route('system_management.locales.index') }}"
               class="nav-link {{ activeClass(['system_management/locales*']) }}">
                <i class="far fa-circle nav-icon"></i>
                <p>{{ __('locales.plural') }}</p>
            </a>
        </li>
    </ul>
</li>

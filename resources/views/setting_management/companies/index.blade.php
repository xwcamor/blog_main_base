  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="card">
        ...
        <div class="card-body">
          @include('setting_management.companies.partials.filters')
        </div>
      </div>
    </div>
  </div>    
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-12 text-right pt-0 pb-1">
              <a class="btn btn-primary" href="{{ route('setting_management.companies.create') }}">
                <i class="fas fa-plus"></i> {{ __('global.create') }}
              </a>
            </div>
          </div>
          <div class="table-responsive">
            @include('setting_management.companies.partials.table')
          </div>
        </div>
      </div>
    </div>

...
@section('title', __('languages.index_title'))
  ...
  <div class="col-lg-12">
    <div class="card card-info rounded">
      ...
      <div class="card-footer text-center">
        ...
        <a href="{{ route('setting_management.languages.index') }}" class="btn btn-default">
    ...
    <div class="card card-info rounded">
      <div class="card-header">
        ...
        <div class="card-tools">
          ...
          <a class="btn btn-sm bg-olive mr-2" href="{{ route('setting_management.languages.edit_all') }}">
      ...
      <div class="card-body">
        <div class="table-responsive">
          @include('setting_management.languages.partials.index_table')
        </div>
      </div>
    </div>
  </div>

...
<div class="row">
  <div class="col-lg-12">
    <div class="card card-info rounded">
      ...
      <div class="card-body">
        @include('setting_management.languages.partials.index_filters')
      </div>
      <div class="card-footer text-center">
        <button type="button" onclick="submitWithParsley()" class="btn btn-primary mr-4">
          <i class="fas fa-search"></i> {{ __('global.search') }}
        </button>
        <a href="{{ route('setting_management.languages.edit_all') }}" class="btn btn-default">
  ...
  <div class="col-lg-12">
    <div class="card card-info rounded">
      <div class="card-header">
        ...
        <div class="card-tools">
          <a class="btn btn-sm btn-primary mr-2" href="{{ route('setting_management.languages.create') }}">
            <i class="fas fa-plus"></i> <span class="d-none d-sm-inline">{{ __('global.create') }}</span>
          </a>
          <a class="btn btn-sm bg-olive mr-2" href="{{ route('setting_management.languages.index') }}">
          ...
          <div class="btn-group">
            ...
            <div class="dropdown-menu dropdown-menu-right">
              <a class="dropdown-item text-dark" href="{{ route('setting_management.languages.export_excel', request()->query()) }}">
                <i class="fas fa-file-excel text-success"></i> {{ __('global.excel') }}
              </a>
              <a class="dropdown-item text-dark" href="{{ route('setting_management.languages.export_pdf', request()->query()) }}">
      ...
      <div class="card-body">
        <div class="table-responsive">
          @include('setting_management.languages.partials.edit_all_table')
        </div>
      </div>
    </div>
  </div>
...
@include('setting_management.languages.partials.edit_all_scripts')
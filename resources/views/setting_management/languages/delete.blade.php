  ...
  <div class="col-lg-12">
    <div class="card card-danger rounded">
      ...
      <div class="card-body">
        ...
        @include('setting_management.languages.partials.form_delete')
      </div>
      <div class="card-footer text-center">
        <button type="submit" form="form-save" class="btn btn-danger">
          <i class="fas fa-trash"></i> {{ __('global.destroy') }}
        </button>
        <a href="{{ route('setting_management.languages.index') }}" class="btn btn-default" title="{{ __('global.back') }}">
